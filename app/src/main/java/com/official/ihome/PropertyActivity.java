...
public class PropertyActivity extends AppCompatActivity {
    ...
    TextView name,state,address,sale,owner,detail,latitude,longitude,price,type;
    Button message;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        sale = findViewById(R.id.PropertyView_Sale);
        type = findViewById(R.id.PropertyView_type);
                    ...
                    for (DataSnapshot userSnapshot : dataSnapshot.getChildren()){
                        for (DataSnapshot propertySnapshot : userSnapshot.getChildren()){
                            ...
                            if (ads.getPropertyID().equals(dataHold)){
                                ...
                                sale.setText(ads.getSale());
                                type.setText(ads.getType());
