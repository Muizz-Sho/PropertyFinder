...
public class EditPropertyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name = findViewById(R.id.edit_propertyName);
        detail = findViewById(R.id.edit_propertyDetail);
        new_name = findViewById(R.id.new_propertyName);
        new_detail = findViewById(R.id.new_propertyDetail);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                detail.setText(property.getDetail());
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(update_name) || TextUtils.isEmpty(update_detail)){
